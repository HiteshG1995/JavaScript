...
var checkResult = 0/0;
console.log(` Result of 0/0 is: ${checkResult} and \n data type of NaN is: ${typeof checkResult}`);

var diffOperation = checkResult * 1000;
console.log(` Result of operation is: ${diffOperation}`);
